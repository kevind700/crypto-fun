    ...
    datasets: [
      {
        data: [
          parseFloat(coin.price_usd) -
            ((parseFloat(coin.price_usd) * parseFloat(coin.percent_change_1h)) /
              100) *
              1.5,
          parseFloat(coin.price_usd) -
            (parseFloat(coin.price_usd) * parseFloat(coin.percent_change_1h)) /
              100,
          parseFloat(coin.price_usd) -
            (parseFloat(coin.price_usd) * parseFloat(coin.percent_change_24h)) /
              200,
          parseFloat(coin.price_usd),
          parseFloat(coin.price_usd) +
            (parseFloat(coin.price_usd) * parseFloat(coin.percent_change_24h)) /
              200,
          parseFloat(coin.price_usd) +
            (parseFloat(coin.price_usd) * parseFloat(coin.percent_change_7d)) /
              100,
          parseFloat(coin.price_usd) +
            ((parseFloat(coin.price_usd) * parseFloat(coin.percent_change_7d)) /
              100) *
      ...
      <ScrollView style={styles.container}>
        ...
        <Surface style={styles.headerCard}>
          ...
          <View style={styles.coinBasicInfo}>
            <View style={styles.coinIdentity}>
              ...
              <View>
                <Text variant="headlineSmall" style={styles.symbolText}>
                  {coin.symbol}
                </Text>
            ...
            <View style={styles.timeframe}>
              ...
              >
                <Text
                  style={[
                    styles.timeframeText,
                    { color: isPositive7d ? "#22c55e" : "#ef4444" },
                  ]}
                >
                  {isPositive7d ? "+" : ""}
        ...
        <Surface style={styles.card}>
          ...
          <View style={styles.statRow}>
            ...
            <Text style={styles.statValue}>
              ${formatValue(parseFloat(coin.market_cap_usd))}
            </Text>
          </View>
          ...
          <View style={styles.statRow}>
            ...
            <Text style={styles.statValue}>
              ${formatValue(parseFloat(coin.volume24))}
            </Text>
          </View>
        </Surface>
        ...
        {totalSupply > 0 && (
          <Surface style={styles.card}>
            ...
            <View style={styles.statRow}>
              ...
              <Text style={styles.statValue}>
                {formatValue(currentSupply)} {coin.symbol}
              </Text>
            </View>
            ...
            {totalSupply > 0 && (
              <View style={styles.statRow}>
                ...
                <Text style={styles.statValue}>
                  {formatValue(totalSupply)} {coin.symbol}
                </Text>
              </View>
            )}
            ...
            {maxSupply > 0 && (
              <View style={styles.statRow}>
                ...
                <Text style={styles.statValue}>
                  {formatValue(maxSupply)} {coin.symbol}
                </Text>
              </View>
            )}
              ...
              <View key={index} style={styles.marketItem}>
                ...
                <View style={styles.marketDetails}>
                  ...
                  <Text style={styles.marketPrice}>
                    ${Number(parseFloat(market.price_usd)).toLocaleString()}
                  </Text>
                  <Text style={styles.marketVolume}>
                    Vol: ${formatValue(parseFloat(market.volume_usd))}
                  </Text>
                </View>
              </View>
            ))}
